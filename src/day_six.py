...
def count_redesitribuition_cycles(starting_state: list) -> int:
    states = []
...
def main():
    initial_state = list(map(lambda x: int(x), re.split("\s+", "14	0	15	12	11	11	3	5	1	6	8	4	9	1	8	4")))
    cycles, size = count_redesitribuition_cycles(initial_state)
    print("cycles    =>", cycles)
